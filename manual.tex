...
\section{Recordings}
The recordings with be saved in the SD card shipped with CoPilot. \textbf{Note the operating system is also located on the SD card. Deleting recordings is of course fine but please do not format the whole disk}. 
